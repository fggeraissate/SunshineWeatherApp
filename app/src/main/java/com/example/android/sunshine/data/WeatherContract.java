...
// Contract is an agreement between the data models, storage and views presentation describing how information is accessed.
public class WeatherContract {
    ...
    // Note also these paths match our two tables.
    ...
    public static final class LocationEntry implements BaseColumns {
        ...
        // CONTENT_URI represents the base location of the table
        ...
        // It is convenient to have in the contract functions to help build the Content Provider queries.
